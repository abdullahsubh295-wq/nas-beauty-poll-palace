...
const Navbar = ({ onBookNow }: NavbarProps) => {
  ...
  return (
    <>
    <nav className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md transition-all duration-300 ${scrolled ? "bg-background/90 shadow-md border-b border-border/60 h-14 md:h-16" : "bg-background/70 border-b border-transparent"}`}>
